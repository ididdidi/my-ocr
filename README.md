...
Предполагается что минимальная и максимальная ширина символа известны заранее, процент наложения можно подобрать эмпирически.

![Параметры распознавания](https://github.com/rbforest/myOCR/blob/master/image/detection%20settings.JPG)

Если все параметры подобраны правильно, то на изображении, использованном в процессе обучения, программа распознает все символы.
